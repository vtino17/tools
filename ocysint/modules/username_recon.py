...
PLATFORMS: Dict[str, Dict[str, Any]] = {
    ...
    "Steam":           {"url": "https://steamcommunity.com/id/{}", "method": "response_url", "deny_substrings": ["error"]},
    ...
    "StackOverflow":   {"url": "https://stackoverflow.com/users/{}", "method": "status_code", "expect": 200},
    ...
    "Upwork":          {"url": "https://www.upwork.com/freelancers/~{}", "method": "status_code", "expect": 200},
    "Paypal":          {"url": "https://www.paypal.com/paypalme/{}", "method": "status_code", "expect": 200},
    "BuyMeACoffee":    {"url": "https://www.buymeacoffee.com/{}", "method": "status_code", "expect": 200},
    ...
    "ProductHunt":     {"url": "https://www.producthunt.com/@{}", "method": "status_code", "expect": 200},
    ...
    "Mastodon.social": {"url": "https://mastodon.social/@{}", "method": "status_code", "expect": 200},
