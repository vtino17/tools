...
CMS_SIGNATURES = {
    "WordPress": [
        r"/wp-content/", r"/wp-includes/", r"/wp-json/", r"wp-login\.php",
        r"<meta name=\"generator\" content=\"WordPress",
    ],
    "Joomla": [
        r"/administrator/", r"com_content", r"<meta name=\"generator\" content=\"Joomla",
    ],
    "Drupal": [
        r"/sites/default/files/", r"/misc/drupal\.js", r"Drupal\.settings",
    ...
    "Shopify": [
        r"cdn\.shopify\.com", r"shopify-features",
    ],
    "PrestaShop": [
        r"prestashop", r"/modules/",
    ],
    "OpenCart": [
        r"catalog/view/javascript", r"opencart",
    ],
    "Laravel": [
        r"laravel", r"XSRF-TOKEN", r"_token",
    ],
    "Django": [
        r"csrfmiddlewaretoken", r"__admin",
    ],
    "ASP.NET": [
        r"__VIEWSTATE", r"__EVENTVALIDATION", r"aspnetForm",
    ],
    "PHP": [
        r"PHPSESSID", r"\?PHPSESSID=",
    ],
    "Tomcat": [
        r"Apache Tomcat", r"JSESSIONID",
    ],
    "IIS": [
        r"X-Powered-By: ASP\.NET", r"X-AspNet-Version",
    ],
    "Express.js": [
    ...
    "Bootstrap": [
        r"bootstrap[-\.min]*\.css", r"bootstrap[-\.min]*\.js",
    ],
    "React": [
