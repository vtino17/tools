...
DEFAULT_PATHS = [
    ...
    "test", "testing", "dev", "development", "staging", "stg",
    "api", "api/v1", "api/v2", "v1", "v2", "rest",
    "docs", "doc", "documentation", "help", "readme", "README",
    "robots.txt", "sitemap.xml", "crossdomain.xml", "favicon.ico",
    ".htaccess", ".htpasswd", ".git", ".git/HEAD", ".git/config",
    ".env", "env", "environment", "wp-config.php", "config.php",
    "web.config", "database.yml", "database.php", "db.php",
    "phpinfo.php", "info.php", "test.php", "debug.php",
    "server-status", "server-info", ".well-known", ".well-known/security.txt",
    "uploads", "upload", "files", "file", "media", "images", "img",
    "css", "js", "scripts", "static", "assets", "public", "private",
    "secret", "secrets", "hidden", "internal", "private", "confidential",
    "logs", "log", "log.txt", "error.log", "access.log", "debug.log",
    "cgi-bin", "cgi", "scripts", "bin", "shell", "cmd", "exec",
    "console", "terminal", "manage", "management", "manager",
    "register", "signup", "join", "create", "new",
    "search", "find", "query", "browse",
    "data", "database", "db", "sql", "mysql", "postgres",
    "xmlrpc.php", "rpc", "soap", "wsdl",
    "swagger", "swagger.json", "swagger.yaml", "openapi.json",
    "graphql", "graphiql", "playground",
    "monitor", "health", "healthcheck", "ping", "alive", "status",
...
def main():
    ...
    with concurrent.futures.ThreadPoolExecutor(max_workers=args.threads) as executor:
        future_to_path = {executor.submit(check_path, session, args.url, path, args.timeout): path for path in paths}
